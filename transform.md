...
R provides functions for the three primary trigonometric functions: sine (`sin)`), cosine (`sin()`), and tangent (`tan()`).
...
In the previous code, I used `pi.
...
#> [1] "Apple"
```
For that reason, if you are using the builtin `pi` variable in computations and paranoid, 
you may want to reference it as `base::pi`.
...
<img src="transform_files/figure-html/unnamed-chunk-88-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-90-1.png" width="70%" style="display: block; margin: auto;" />
...
Many of these planes have only flown a small number of flights.
...
To account for planes that have a small number of flights, I will remove 
planes hat flew at least 20 flights.
The choice of 20 for the threshold is somewhat arbitrary; it is a round number near the first quartile of number of flights by plane [^delay]
...
<img src="transform_files/figure-html/unnamed-chunk-113-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-116-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-120-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-122-1.png" width="70%" style="display: block; margin: auto;" />
